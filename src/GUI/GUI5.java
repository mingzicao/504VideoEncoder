...
public class GUI5 extends BorderPane {
	private Media media;
	...
	//private ComboBox effectbutton;
	
	
	public GUI5(javafx.stage.Stage stage){
		theStage=stage;
		setPrefSize(800, 600);
		...
		hBox.getChildren().addAll(endButton,backButton,playButton,foreButton,openButton);
